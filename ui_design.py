...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.web = QWebEngineView(self.tabDatos)
        self.web.setObjectName(u"QWebEngineView")
        self.web.setGeometry(QRect(10, 360, 441, 251))

        

        # self.listView = QListView(self.tabDatos)
        # self.listView.setObjectName(u"listView")
        # self.listView.setGeometry(QRect(10, 360, 441, 251))
        ...
        self.webPDF.setGeometry(QRect(0, 0, 441, 251))
